    ...
    <ThemeContext.Consumer>
      {({
        ...
        <div
          ...
          className={theme === 'light' ? 'index-page' : 'index-page dark'}
        >
          <div className='container'>
            <div className='landing'>
              <div
                className='smoketrees'
                data-aos='fade-in'
              ...
              <div
                ...
                data-aos-duration={
                  window.innerWidth < 800 ? { animationSpeed } : ''
                }
                id='head-description'
              >
                <p>
                  <span>
                    ...
                    <br />
                    backed by <span className='technology'>technology</span>
                  </span>
                </p>
                {/* <div className='btn'>
                                Explore
            ...
            <div
              ...
              data-aos-duration={animationSpeed}
            >
              We <span className='build'>build</span> what you{' '}
              <span className='build'>ideate</span>.
            </div>
            <div className='container-basic'>
              <div
                className='description'
                data-aos={dimensions.width > 800 ? 'fade-right' : 'fade-up'}
                data-aos-duration={animationSpeed}
              >
                <h1>GitHub</h1>
                <p>
                  Check out our project implementations here, that we believe
                  are robust, and should be scrutinized by everyone so that they
                  can see for themselves our raw work.
                  <br />
            ...
            <div className='container-basic'>
              <div
                className='logo-svg'
                data-aos={dimensions.width > 800 ? 'fade-left' : 'fade-up'}
                data-aos-duration={animationSpeed}
              >
              ...
              >
                <div className='alter-extra-div'>
                  <h1>Our Projects</h1>
                  <p>
                    CESS: Comprehensive Electoral Solutions Suite - an elections
                    suite software which merges RFID and fingerprint recognition
                    with extra layers of security which checks emotion when you
                    vote while securing your transaction via a smart ethereum
                    contract.
                  </p>
                </div>
                <Link to='/projects'>
                  <div className='btn'>
                    <div className='elements'>
                      <div className='git'>More Projects</div>
                    </div>
                  </div>
                </Link>
              </div>
            ...
            <div className='container-basic client'>
              ...
              >
                ...
                <p>
                  ...
                  SmokeTrees. Regular milestone updates on GitHub and
                  development using the Flutter framework have made my work lot
                  easier.
                </p>
                <p
                  style={{
